...
/*
 * sharkPy_capture_sync.c is a modified (minor modifications) version of code found in
 * print.c, code compiled as a shared lib that exposes dissection and object export
 * interfaces to sharkPy Python modules. sharkPy extends functionality and modifies tshark.
 *
...
extern char *sharkPy_program_dir;
...
/*
 * Initialize an argument list and add dumpcap to it. Modified from original
 * to acquire profile_dir from global var, a variable set by sharkPy caller.
 */
static char **
init_pipe_args(int *argc) {
    ...
    progfile_dir = sharkPy_program_dir;
...
sync_pipe_start(capture_options *capture_opts, capture_session *cap_session, void (*update_cb)(void))
{
    ...
    dumpcap_pid=cap_session->fork_child;
